    ...
    return (
        <footer className="bg-gray-900 text-gray-300 pt-16 pb-8 px-6">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-10 mb-12">
                            ...
                            <div className="flex items-center gap-2 cursor-pointer">
                                ...
                                <div>
                                    <a href="/" className="flex flex-col leading-none">
                                        <span className="font-bold text-[18px] tracking-tighter text-white uppercase">
                                            HouseXpertz
                                        </span>
                                        <span className="font-medium text-[14px] tracking-tight text-gray-300">
                                            Service
                                        </span>
                                    </a>
                                </div>
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-2 text-sm text-slate-400">
                            <Link to="/blogs"><li className="hover:text-white">About Us</li></Link>
                            <Link to="/categories"><li className="hover:text-white">Our Services</li></Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-slate-400">
                            <li className="hover:text-white cursor-pointer">AI Appliance Repair</li>
                            <li className="hover:text-white cursor-pointer">Smart Home Setup</li>
                            <li className="hover:text-white cursor-pointer">Electrical Works</li>
                            <li className="hover:text-white cursor-pointer">Plumbing & Cleaning</li>
                        </ul>
                    </div>

                    {/* Column 4: Service Regions */}
                    <div>
                        <h4 className="text-white font-bold mb-6 uppercase tracking-wider">Service Regions</h4>
                        <ul className="space-y-3 text-sm text-slate-400">
                            <li className="hover:text-white cursor-pointer">Delhi</li>
                            <li className="hover:text-white cursor-pointer">Noida</li>
                            <li className="hover:text-white cursor-pointer">Gurgaon</li>
                            <li className="hover:text-white cursor-pointer">Bhubaneswar</li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-slate-400">
                            <li className="flex items-start gap-3">
                                ...
                                <span>
                                    9 Guru Nanak Market, Lajpat Nagar 4, New Delhi - 110024
                                </span>
                            </li>
