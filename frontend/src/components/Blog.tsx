...
const BlogPage = () => {
  ...
  const customerStories = [
    { id: 1, name: "Sneha Kapoor", location: "Gurugram", story: "My sofa looked beyond repair after my toddler's party. The Handyman Pro spent 3 hours and now it looks brand new.", service: "Deep Sofa Cleaning", avatar: "https://i.pravatar.cc/150?u=sneha" },
    { id: 2, name: "Rahul Mehra", location: "Mumbai", story: "Getting my AC serviced was always a hassle until I tried Handyman Service. Transparent pricing and no mess.", service: "AC Power Jet Service", avatar: "https://i.pravatar.cc/150?u=rahul" },
  ];
      ...
      <header className="max-w-7xl mx-auto px-6 pt-24 pb-12">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="text-5xl md:text-7xl font-black text-slate-900 tracking-tighter mb-4">
            Handyman <span className="text-blue-600">Journal</span>
          </h1>
      ...
      <section className="bg-slate-900 py-28 mb-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
              ...
              <p className="text-slate-400 font-medium text-lg">Real experiences from people who trusted Handyman Service.</p>
          </div>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[4rem] p-12 md:p-24 text-center relative overflow-hidden shadow-3xl shadow-blue-200">
          <div className="relative z-10">
            ...
            <p className="text-blue-100 font-medium mb-12 text-lg md:text-xl opacity-90">
                Book a professional Handyman in less than 60 seconds.
            </p>
